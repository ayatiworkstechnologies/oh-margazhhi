...
export default function ExperienceSection() {
    return (
        <section >
            <Container className="relative bg-primary py-16 text-center overflow-hidden">
                {/* 🔹 TOP BORDER PATTERN */}
                ...
                <div className="relative z-10 py-20">
                    ...
                    {/* FEATURE GRID */}
                    <div className="my-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 place-items-center">
                        {items.map((text, idx) => (
                            <div
                                key={idx}
